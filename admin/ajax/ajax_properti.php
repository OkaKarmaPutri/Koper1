<script type="text/javascript">
	...
	function addFt(){
		$('#ft').append('<div class="form-group"><div class="col-sm-2 foto" style="display: none"></div><div class="col-sm-10 foto" style="display: none"><img height="200px"></div><label class="col-sm-2 control-label"></label><div class="col-sm-9"><input type="file" class="form-control" name="ft"></div><div class="col-sm-1 control-label"><button type="button" class="minFt">-</button></div></div>');
	...
	$('#save').click(function(){
		...
		var aksi = $('#form').attr('action'), us = $('select[name=us]'), tp_pro = $('select[name=tp_pro]'), nm_pro = $('textarea[name=nm_pro]'), al = $('textarea[name=al]'), result = 0, result1 = 0, jumKmr = $('input[name=jumKamar]'), kmrSedia = $('input[name=kmrSedia]'), ft = $('input[name=ft]');
